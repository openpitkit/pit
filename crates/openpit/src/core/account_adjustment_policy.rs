...
/// use openpit::AccountAdjustmentPolicy;
...
///     }
///
///     fn apply_account_adjustment(&self, _ctx: &AccountAdjustmentContext, _account_id: AccountId, adjustment: &i64, _mutations: &mut Mutations) -> Result<(), Rejects> {
///         if *adjustment < 0 {
